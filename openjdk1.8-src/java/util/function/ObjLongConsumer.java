 ...
 * @see BiConsumer
 * @since 1.8
 */ // 由 GaoZhilai 进行分析注释, 不正确的地方敬请斧正, 希望帮助大家节省阅读源代码的时间 2020/4/25 20:23
@FunctionalInterface
public interface ObjLongConsumer<T> { /** 函数式接口, 接收消耗一个T类型对象和一个long参数, 无返回结果. 是{@link BiConsumer}的特定版本 */
